...
** Changed the minimu9-ahrs-calibrator Python script to use "SciPy":http://scipy.org instead of the old optimization algorithm.  This should make it faster and more reliable.
