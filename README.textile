...
** Changed the minimu9-ahrs-calibrator Python script to use [scipy](scipy.org) instead of the old optimization algorithm.  This should make it faster and more reliable.
